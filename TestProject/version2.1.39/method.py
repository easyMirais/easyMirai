...
class Mirai(Init):
    ...
    @property
    def send(self):
        return models.sendTypeMode(session=self._session, uri=str(self._url))
    ...
    @property
    def set(self):
        return models.setTypeMode(session=self._session, uri=str(self._url))
    ...
    @property
    def action(self):
        return models.actionTypeMode(session=self._session, uri=str(self._url))
